...
function init() {
    ...
    renderer = new THREE.WebGLRenderer({ antialias: true, canvas: document.getElementById('xr-canvas') });
    renderer.setSize(window.innerWidth, window.innerHeight);
    renderer.xr.enabled = true;
    document.body.appendChild(THREE.WebXRUtils.createButton(renderer)); // Add XR button
